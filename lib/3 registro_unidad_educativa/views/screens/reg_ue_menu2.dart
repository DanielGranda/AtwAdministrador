...
import 'package:administrador/3%20registro_unidad_educativa/views/screens/boton_add_plantel_ue.dart';
import 'package:administrador/3%20registro_unidad_educativa/views/widgets/botonAddProducto.dart';
import 'package:administrador/3%20registro_unidad_educativa/views/widgets/botonAddRoles.dart';
  ...
  AppBar cabecera(BuildContext context) {
    return new AppBar(
      leading: IconButton(
        ...
        onPressed: () async {
          Navigator.popAndPushNamed(context, 'agregarUe');
